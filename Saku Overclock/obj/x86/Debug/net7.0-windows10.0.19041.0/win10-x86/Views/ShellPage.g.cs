...
namespace Saku_Overclock.Views
{
        ...
        global::Microsoft.UI.Xaml.Markup.IComponentConnector
    {
            ...
            IShellPage_Bindings
        {
            ...
            private global::Saku_Overclock.Behaviors.NavigationViewHeaderBehavior obj5;
            ...
            public void Connect(int connectionId, global::System.Object target)
            {
                switch(connectionId)
                {
                    ...
                    case 5: // Views\ShellPage.xaml line 83
                        this.obj5 = global::WinRT.CastExtensions.As<global::Saku_Overclock.Behaviors.NavigationViewHeaderBehavior>(target);
                        break;
                    default:
                        break;
                }
            ...
            private void Update_ViewModel_Selected_Cast_Selected_To_ContentControl_Content(global::System.Object obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    ...
                    {
                        XamlBindingSetters.Set_Saku_Overclock_Behaviors_NavigationViewHeaderBehavior_DefaultHeader(this.obj5, obj, null);
                    }
                }
            }

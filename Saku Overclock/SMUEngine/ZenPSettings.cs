...
public class ZenPSettings : SMU
{
    public ZenPSettings()
    {
        ...
        Rsmu.SMU_MSG_EnableOcMode = 107U;
        Rsmu.SMU_MSG_SetOverclockFrequencyAllCores = 108U;
        Rsmu.SMU_MSG_SetOverclockFrequencyPerCore = 109U;
        Rsmu.SMU_MSG_SetOverclockCpuVid = 110U;
        Rsmu.SMU_MSG_SetPPTLimit = 100U;
        Rsmu.SMU_MSG_SetTDCVDDLimit = 101U;
        Rsmu.SMU_MSG_SetEDCVDDLimit = 102U;
        Rsmu.SMU_MSG_SetHTCLimit = 104U;
        Rsmu.SMU_MSG_SetPBOScalar = 106U;
        Rsmu.SMU_MSG_GetPBOScalar = 111U;
